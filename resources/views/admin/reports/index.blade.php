...
<head>
    ...
    <title>Laporan Penjualan - Admin POSIFY</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.reports.print', request()->all()) }}" target="_blank" class="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold transition shadow-lg flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            ...
            <form method="GET" action="{{ route('admin.reports.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                ...
                <div class="flex items-end space-x-2 md:col-span-2">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-semibold transition">
                        Reset
                    </a>
                </div>
            </form>
