...
<head>
    ...
    <title>Edit Pengguna - POSIFY</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white flex-shrink-0 flex flex-col relative">
            <div class="p-6">
            ...
            <nav class="mt-6 flex-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.transactions.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    Riwayat Transaksi
                </a>
                <a href="{{ route('admin.reports.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="p-8">
                <div class="max-w-3xl">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <div class="flex items-center">
                            ...
                            <div class="text-sm text-blue-800">
                                <span class="font-semibold">Terdaftar:</span> {{ $user->created_at->format('d M Y, H:i') }} WIB
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
                        <h3 class="text-xl font-semibold text-gray-800 mb-6">Informasi Pengguna</h3>
                        ...
                        <form action="{{ route('admin.users.update', $user) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="address" id="address" rows="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent @error('address') border-red-500 @enderror">{{ old('address', $user->address) }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                                ...
                                <label class="flex items-start">
                                    ...
                                    <div class="ml-2">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">
                                            Jika dinonaktifkan (uncheck), pengguna tidak akan bisa login ke sistem dan akan otomatis logout jika sedang login.
                                        </p>
                                    </div>
                                </label>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <p class="text-gray-600 text-sm mb-6">Ubah password pengguna jika diperlukan</p>
                        ...
                        <form action="{{ route('admin.users.reset-password', $user) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="password" name="new_password" id="new_password" required
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent @error('new_password') border-red-500 @enderror">
                                @error('new_password')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
