...
<head>
    ...
    <title>Kelola Pengguna - POSIFY</title>
            ...
            <header class="bg-white shadow">
                <div class="px-8 py-6">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('admin.users.create') }}" class="bg-primary hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition flex items-center">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('admin.users.edit', $user) }}" class="text-blue-600 hover:text-blue-900 transition" title="Edit">
