            ...
            <main class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
                        ...
                        <p class="text-3xl font-bold mt-2">Rp {{ number_format($totalSalesToday, 0, ',', '.') }}</p>
                    ...
                    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
                        ...
                        <p class="text-3xl font-bold mt-2">{{ $totalTransactionsToday }}</p>
                        <p class="text-sm mt-2 opacity-80">Hari ini</p>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button class="bg-gradient-to-br from-primary to-red-600 text-white rounded-xl p-4 hover:shadow-lg transition" onclick="window.location.href='{{ route('admin.products.create') }}'">
                                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                                <p class="text-sm font-semibold">Tambah Barang</p>
                            </button>
                            <button class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-4 hover:shadow-lg transition" onclick="window.location.href='{{ route('admin.users.create') }}'">
                                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                                </svg>
                                <p class="text-sm font-semibold">Tambah Pengguna</p>
                            </button>
                            <button class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-4 hover:shadow-lg transition" onclick="window.location.href='{{ route('admin.reports.index') }}'">
                                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                <p class="text-sm font-semibold">Lihat Laporan</p>
                            </button>
                            <button class="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl p-4 hover:shadow-lg transition" onclick="window.location.href='{{ route('admin.transactions.index') }}'">
                                <svg class="w-8 h-8 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
